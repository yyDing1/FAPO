...
TRAIN_FILE=${TRAIN_FILE:-"${RAY_DATA_HOME}/data/fapo-math-critic.parquet"}
TEST_FILE=${TEST_FILE:-"${RAY_DATA_HOME}/data/fp_bench_test.parquet"}
...
python3 -m verl.trainer.main_ppo \
    ...
    custom_reward_function.path=fapo/fapo_genrm/reward_fn.py \
